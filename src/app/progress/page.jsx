        ...
        <>
            ...
            <div id="inicio" className="container">
                ...
                <SubjectCards SubjectInfo={[
                    {id: 1, tittle: 'Razonamiento lógico', href: '/razonamientologico', image: '/ImgMatemática.png'},
                    {id: 2, tittle: 'Lectura Critica', href: '/lecturacritica', image: '/ImgLengua.png'},
                    {id: 3, tittle: 'Sociales y ciudadanas', href: '/sociales&ciudadanas', image: '/ImgSociales.png'},
                    {id: 4, tittle: 'Ciencias naturales', href: '/naturales', image: '/ImgNaturales.png'},
                    {id: 5, tittle: 'Ingles', href: '/ingles', image: '/ImgIngles.png'},
                ]}/>
            </div>
